                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if names[c] == 'qi':
                            ...
                            qi_x1 = c1[1]
                            qi_x2 = c2[1]
                        print(f"目标名称：{names[c]}",
                              "左上点的坐标为：(" + str(c1[0]) + "," + str(c1[1]) + ")，右下点的坐标为(" + str(c2[0]) + "," + str(
                                  c2[1]) + ")")
...
class DetectApi:
    ...
    def detect(self, source,conf_thres=0.25):  # 使用时，调用这个函数
        nosave = self.nosave
